 ...
 *
 * 2026-07-07 (Tartrinator) — Le composer intégré a été retiré.
 * Le point d'entrée pour composer une newsletter est désormais la
 * Bibliothèque (`/dashboard/library`), où chaque article dispose d'un
 * bouton "Composer une newsletter avec cet article".
 * Cette page ne contient plus que l'historique des envois + filtres.
 */
export default async function NewsletterHistoryPage({
  ...
  // Stats patients actifs (réutilisé pour le bandeau d'info)
      ...
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            {activeStats.count} patient(s) actif(s) · Tous les envois du cabinet, brouillons inclus.
          </p>
        </div>
        <Link
          href="/dashboard/library"
          className="inline-flex items-center gap-2 rounded-md bg-primary px-3 py-1.5 text-sm font-semibold text-primary-foreground shadow-sm hover:opacity-95"
        >
