  ...
  return (
    <header className="sticky top-0 z-20 flex h-14 items-center justify-between gap-3 border-b border-border bg-background/95 px-4 backdrop-blur supports-[backdrop-filter]:bg-background/60 md:px-6">
      ...
      <div className="flex items-center gap-2">
        ...
        {/* CTA secondaire : Inviter (ouvre modale globale) */}
        <button
          type="button"
          onClick={() => invite.open()}
          className="hidden items-center gap-1.5 rounded-md border border-border bg-background px-3 py-1.5 text-xs font-medium transition-colors hover:bg-muted sm:inline-flex"
        ...
        {/* CTA tertiaire : Stats (scroll vers KPIs si on est sur /dashboard) */}
        <Link
